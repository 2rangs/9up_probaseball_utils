...
<template>
  <div class="max-w-[1280px] m-auto p-2">
      ...
      <div class="sm:col-start-3">
        ...
        <div class="relative">
          <input
              ...
              class="w-full bg-white/90 dark:bg-gray-800/90 border border-gray-200 dark:border-gray-700 rounded-md px-3 py-2 pr-10 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 shadow-sm focus:ring-4 focus:ring-blue-500/15 focus:border-blue-500 transition"
              aria-label="검색어"
          />
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
      <!-- 등급 / 레어도 / 팀 -->
      <div class="p-4 rounded-lg dark:bg-gray-800 bg-white/90 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div class="mt-3 flex gap-1.5">
          <button
              ...
              class="p-1.5 rounded-md hover:bg-yellow-100/60 dark:hover:bg-yellow-900/25 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-yellow-400/60"
              :aria-pressed="i <= props.filters[rarityField]"
              :title="`${i} Star`"
          >
            <Star
                :class="i <= props.filters[rarityField] ? 'text-yellow-400 drop-glow' : 'text-gray-300 dark:text-gray-600'"
                class="w-5 h-5"
                fill="currentColor"
            />
          </button>
        ...
        <div class="mt-4 grid grid-cols-5 gap-3">
          <div
              ...
              class="overflow-hidden h-[44px] flex items-center justify-center rounded-md cursor-pointer transition
                   ring-1 ring-inset
                   "
              :class="isSelected('grade', grade)
              ? 'bg-white dark:bg-gray-900 ring-blue-400/60 shadow-sm hover:shadow'
              : 'bg-white/70 dark:bg-gray-800/70 ring-gray-200 dark:ring-gray-700 grayscale hover:grayscale-0 hover:brightness-100'"
        ...
        <div class="mt-4 grid grid-cols-7 gap-2.5">
          <button
              ...
              class="relative p-1 rounded-md transition-colors cursor-pointer flex items-center justify-center border bg-white/95 dark:bg-gray-900/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400/60"
              :class="[
              isSelected('team', team)
                ? 'border-blue-500 ring-1 ring-blue-300 shadow-sm'
                : 'border-gray-200 dark:border-gray-700 grayscale hover:grayscale-0 hover:brightness-100'
            ]"
          >
      ...
      <!-- 포지션 야구장 UI -->
      <div class="rounded-lg bg-white/90 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-4 shadow-sm hover:shadow-md transition-shadow">
        <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2 flex items-center gap-1">
          ...
          <div class="relative w-full h-64 mx-auto">
            ...
            <div class="absolute top-[8%] left-1/2 transform -translate-x-1/2">
              <button v-if="actualPositions.includes('CF')" @click="toggleFilter('position', 'CF')"
                      :class="[
                  'p-2 w-20 rounded-md text-sm font-bold transition-colors border focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400/60',
          ...
          >
            ...
            <div class="flex gap-1.5 flex-wrap justify-center">
              <button
                  ...
                  :class="[
                  'px-2 py-1.5 rounded-md text-xs font-medium transition border focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400/60',
      ...
      <div class="bg-white/90 dark:bg-gray-900 rounded-lg p-4 shadow-sm hover:shadow-md border border-gray-200 dark:border-gray-700 flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto max-h-74 rounded-lg border border-gray-200 dark:border-gray-700 p-2 bg-gray-50/80 dark:bg-gray-800/80">
    ...
    <div class="flex justify-between items-center pt-4 border-t border-gray-100 dark:border-gray-700 mb-6">
      ...
      <button
          ...
          class="px-3 py-1.5 bg-red-100 text-red-700 dark:text-gray-200 rounded-md hover:bg-red-200 dark:hover:bg-gray-700 transition-colors text-xs font-medium flex items-center gap-1 ring-1 ring-inset ring-red-300/50 dark:ring-gray-600/60"
      >
